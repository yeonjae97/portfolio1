...
<!DOCTYPE html>
  <!-- Footer Section Start -->
                ...
                <div class="row g-md-4 g-3">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4">
                        <div class="footer-title">
                            <div class="">
                                <h4 class="float-start mr-5" style="color: #417505">공지사항</h4>
                                <a href="#" class="float-end"><i class="fas fa-arrow-right fa-2xl" style="color: #417505"></i></a>
                            </div>
                        </div>
                        <br>
                        <hr>
                        <div class="footer-contain">
                            <ul>
                                <li>
                                    <a href="#" class="text-content">공지사항3</a>
                                </li>
                                <hr>
                                <li>
                                    <a href="#" class="text-content">공지사항2</a>
                                </li>
                                <hr>
                                <li>
                                    <a href="#" class="text-content">공지사항1</a>
                                </li>
                                <hr>
                            </ul>
                        </div>
    ...
    <!-- jquery ui-->
    <script src="${pageContext.request.contextPath}/resources/assets2/js/jquery-ui.min.js"></script>
