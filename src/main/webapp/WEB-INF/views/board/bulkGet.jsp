...
<body>
                    ...
                    <div class="log-in-box">
                        ...
                        <div class="input-box">
							...
							<form method="post" id="frm">
								...
								<div class="col-12">
                                    <div class="form-floating theme-form-floating form-group">
                                    <input type="text" class="form-control" id="company" name="company" readonly  style="background-color: white" value="${board.company}">
                                </div>
                                <br>
								<div class="col-12">
                                    <div class="form-floating theme-form-floating form-group">
                                    <input type="text" class="form-control" id="name" name="name" readonly  style="background-color: white" value="${board.writer}">
                                </div>
								<br>
                                </div>
								...
								<div class="col-12">
									<div class="form-floating theme-form-floating form-group">
										<input type="text" class="form-control" id="addr" name="addr" readonly style="background-color: white" value="${board.addr}"> 
									</div>
								<br>
								</div>
								<div class="col-12">
									<div class="form-floating theme-form-floating form-group">
										<input type="text" class="form-control" id="email" name="email" readonly style="background-color: white" value="${board.email}">
									</div>
									<br>
								</div>
								<div class="col-12">
									<div class="form-floating theme-form-floating form-group">
										<input type="text" class="form-control" id="phone" name="phone" readonly style="background-color: white" value="${board.phone}">
									</div>
									<br>
								</div>
								...
								<div class="justify-content-center position-relative d-flex">
									<div class="col-3 m-3">
										<a href="${pageContext.request.contextPath}/board/bulk?category=2"><button
    ...
    <!-- log in section end -->
	<c:if test="${member.adminGrant == 1 && member.id ne board.id}">
		<script>
			alert("권한이 없습니다");
